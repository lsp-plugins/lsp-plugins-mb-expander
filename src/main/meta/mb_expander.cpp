...
#define LSP_PLUGINS_MB_EXPANDER_VERSION_MICRO       10
...
namespace lsp
{
    namespace meta
    {
        ...
        #define MB_FFT_METERS(id, label) \
            ...
            MESH("ifg" id, "Input FFT graph" label, 2, mb_expander_metadata::FFT_MESH_POINTS), \
        ...
        #define MB_STEREO_BAND(id, label, x, total, fe, fs) \
            COMBO("scs" id, "Sidechain source" label, dspu::SCS_MIDDLE, mb_exp_sc_source), \
