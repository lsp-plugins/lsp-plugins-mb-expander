...
namespace lsp
{
    namespace meta
    {
        ...
        #define MB_BAND_COMMON(id, label, alias, x, total, fe, fs) \
            ...
            LOG_CONTROL_DFL("sclf" id, "Sidechain lo-cut frequency" label, "SC LCF" label, U_HZ, mb_expander_metadata::FREQ, fe), \
            LOG_CONTROL_DFL("schf" id, "Sidechain hi-cut frequency" label, "SC HCF" label, U_HZ, mb_expander_metadata::FREQ, fs), \
